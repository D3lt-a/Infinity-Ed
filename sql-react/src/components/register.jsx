function Register() {
    return (
        <div >
            ...
            <form className="max-w-md mx-auto my-10 shadow-xl p-7">
                <h1 className="font-mono text-2xl font-bold">Create an Account</h1>
                ...
                <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">Already have an account? <a href="#" className="font-medium text-blue-600 hover:underline dark:text-blue-500">Login</a>.</p>
            </form>
        </div>
    )
}
